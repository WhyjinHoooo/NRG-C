...
$(document).ready(function(){
	...
	$('.OkBtn').click(function(){
		...
		if(!pass && RowNum === 0){
			...
			$.ajax({
				url : '${contextPath}/Approval/SDG.do',
				type : 'POST',
				data :  JSON.stringify(FilterList),
				contentType: 'application/json; charset=utf-8',
				dataType: 'json',
...
<div class="StockArea">
	<div class="StockArea-Filter">
		...
		<div class="InfoInput">
			...
			<input type="text" class="UploadDataCode FilterOP" name="UploadDataCode" value="SDG" readonly>
		</div>
		...
		<div class="StockArea-Uploading">
			...
			<div class="File-Uploading-Area">
				<div class="InfoInput">
					...
					<div id="ErrorMess">(File명 : "SDGyyyymm.txt")</div>
