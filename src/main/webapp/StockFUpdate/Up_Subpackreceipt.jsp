...
$(document).ready(function(){
	...
	$('.OkBtn').click(function(){
		...
		if(!pass && RowNum === 0){
			...
			$.ajax({
				url : '${contextPath}/Approval/MGR.do',
				type : 'POST',
				data :  JSON.stringify(FilterList),
				contentType: 'application/json; charset=utf-8',
				dataType: 'json',
...
<div class="StockArea">
	...
	<div class="StockArea-Result">
		<div class="StockArea-Data-Area">
			<div class="Title">소분 생산입고 실적 현황</div>
			<table class="InfoTable">
					<thead class="InfoTable-Header">
					<tr>
						<th>순번</th><th>입출고유형</th><th>결산월</th><th>입고일자</th><th>자재코드</th><th>자재명</th><th>규격</th>
						<th>자재유형</th><th>입고중량</th><th>작지ID</th><th>바코드</th><th>공장</th><th>기업</th>
					</tr>
				</thead>
